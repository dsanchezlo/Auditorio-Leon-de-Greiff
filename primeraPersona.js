...
var primeraPersona = {
  preload : function() {
    mapa.load.image('imagen0', 'imagenes/1.jpg');
    mapa.load.image('imagen1', 'imagenes/2.jpg');
    mapa.load.image('imagen2', 'imagenes/3.jpg');
    mapa.load.image('imagen3', 'imagenes/4.jpg');
    mapa.load.image('imagen4', 'imagenes/5.jpg');
    mapa.load.image('imagen5', 'imagenes/6.jpg');
    mapa.load.image('imagen6', 'imagenes/7.jpg');
    mapa.load.image('imagen7', 'imagenes/8.jpg');
    mapa.load.image('imagen8', 'imagenes/9.jpg');
    mapa.load.image('imagen9', 'imagenes/10.jpg');
    mapa.load.image('imagen10', 'imagenes/11.jpg');
    mapa.load.image('imagen11', 'imagenes/12.jpg');
    mapa.load.image('imagen12', 'imagenes/13.jpg');
  ...
  moverAdelante : function() {
    ...
    if ( imagenes[fondoActual].tilePosition.x > -153 ){
  ...
  moverAtras : function() {
    ...
    if ( imagenes[fondoActual].tilePosition.x >= 0){
      ...
      imagenes[fondoActual].visible = true;
      imagenes[fondoActual].tilePosition.x = -153;
    }
  }
}
